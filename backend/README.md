...
## Project Structure
    ...
    ├── my_card_collection_32634  # Django project configurations
...
1. Clone this repo and `cd my_card_collection_32634`
...
2. Clone this repo and `cd my_card_collection_32634`
